						...
						<div class="card-body">
							<div class="email-left-box px-0 mb-5">
								...
								<div class="mail-list mt-4">
									<a href="/dabomweb/contact-message/sendContact"
										class="list-group-item active"> <i
										class="fa fa-inbox font-18 align-middle mr-2"></i> 메세지 작성하기 <span
										class="badge badge-primary badge-sm float-right"></span>
									</a> <a href="/dabomweb/contact-message/sendContactList"
										class="list-group-item"> <i
										class="fa fa-paper-plane font-18 align-middle mr-2"></i> 
										보낸메세지함
										...
										class="fa fa-trash font-18 align-middle mr-2"></i> 삭제한 메세지
									</a>
