									...
									<div class="card-header d-block">
										...
										<c:choose>
											<c:when test="${ contact.writertype eq 'admin' }">
												<p class="mb-0 subtitle">발송일&nbsp;&nbsp;<fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${ contact.sendDate }"/></p>
											</c:when>
											<c:otherwise>
												<p class="mb-0 subtitle">수신일&nbsp;&nbsp; <fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${ contact.sendDate }"/></p>
											</c:otherwise>
										</c:choose>
									</div>
									<c:choose>
										...
										<c:otherwise>
											<div class="col-xl-6">
												<div class="alert alert-dark notification f">
