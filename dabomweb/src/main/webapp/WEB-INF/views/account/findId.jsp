...
<link rel="icon" type="image/png" sizes="16x16"
	href="/dabomweb/resources/images/favicon.png">
							...
							<div class="col-xl-12">
								<div class="auth-form">
									...
									<form id="findId_form" method="post"
										action="/dabomweb/account/findId">
										<div class="form-group">
											<label><strong>아이디</strong></label> <input type="text"
										...
										<div class="text-center">
											<a href="javascript:" id="findId"
												class="btn btn-primary btn-block">비밀번호 찾기</a>
										</div>
									</form>
									<div class="new-account mt-3">
										<p>
											Don't have an account? <a class="text-primary"
												href="/dabomweb/account/register">Sign up</a>
										</p>
									</div>
								</div>
							</div>
