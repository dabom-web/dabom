...
<head>
 <meta charset="utf-8">
    ...
    <meta name="viewport" content="width=device-width,initial-scale=1">
 	<title>메세지읽기(${ receiveCount })</title>
                            ...
                            <div class="card-body">
                                <div class="email-left-box generic-width px-0 mb-5">
                                  ...
                                  <div class="mail-list mt-4">
                                      ...
                                      <a href="message_receive_delete_list?receiver=${ loginuser.memberId }&sender=${ loginuser.memberId }" class="list-group-item active"><i
                                              class="fa fa-trash font-18 align-middle mr-2"></i> 받은메세지 휴지통 <span
                                              class="badge badge-danger text-white badge-sm float-right">${ deleteReceiveCount }</span></a>                                              
                                                            ...
                                                            <div class="dropdown custom-dropdown">
					                                            ...
					                                            <div class="dropdown-menu dropdown-menu-right">
					                                                <a class="dropdown-item" 
					                                                	href="/dabomweb/mychannel/channel?member_Id=${ message.sender }&subscriber=${loginuser.memberId}">채널방문</a>
					                                                <a class="dropdown-item" 
