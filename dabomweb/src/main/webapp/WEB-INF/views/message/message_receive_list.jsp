                      ...
                      <div class="card">
                          <div class="card-body">
                              <div class="email-left-box px-0 mb-5">
                                  <div class="p-0">
                                      <a href="message_write?sender=${ loginuser.memberId }" class="btn btn-primary btn-block">새 메세지 작성</a>
                                  </div>
	                                  ...
	                                  <div class="email-list mt-5">
	                                      <div class="message">
	                                          <div>
	                                              ...
	                                              <a href="message_receive_detail?message_no=${ message.message_No }" class="col-mail col-mail-3">  
