                      ...
                      <div class="card">
                          <div class="card-body">
                              <div class="email-left-box px-0 mb-5">
                                  <div class="p-0">
                                      <a href="messagewrite" class="btn btn-primary btn-block">새 메세지 작성</a>
                                  </div>
                                  <div class="mail-list mt-4">
                                      ...
                                      <a href="javascript:void()" class="list-group-item"><i
                                              class="fa fa-paper-plane font-18 align-middle mr-2"></i>보낸메세지</a> <a href="javascript:void()" class="list-group-item"><i
