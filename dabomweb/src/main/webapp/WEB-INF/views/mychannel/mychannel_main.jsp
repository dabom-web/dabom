                      ...
                      <div class="card-body">
                          <div class="profile-statistics">
                              <div class="text-center mt-4 border-bottom-1 pb-3">
                                  <div class="row">
                                      <div class="col">
                                          <h3 class="m-b-0">150</h3><span>팔로워</span>
                                      </div>
                                      <div class="col">
                                          <h3 class="m-b-0">140</h3><span>좋아요</span>
                                      </div>
                                      <div class="col">
                                  ...
                                  <div class="mt-4">
	                                 <a href="javascript:void()" class="btn btn-primary pl-4 pr-4 mr-3 mb-4">팔로우</a> 
	                                 <a href="javascript:void()" class="btn btn-primary pl-4 pr-4 mr-3 mb-4">좋아요</a> 
	                                 <a href="javascript:void()" class="btn btn-dark pl-5 pr-5 mb-4">메세지 보내기</a>
                                  </div>
                              </div>
                          </div>
                      </div>
                                      ...
                                      <div id="my-posts" class="tab-pane fade active show">
                                          <div class="my-post-content pt-3">                                              
                                              ...
                                              <div class="post-input">
                                                  <textarea name="textarea" id="textarea" cols="30" rows="5" class="form-control bg-transparent" placeholder="채널주인만 볼수있게...."></textarea> 
                                                  <a href="javascript:void()"><i class="ti-clip"></i> </a>
                                                  <a href="javascript:void()"><i class="ti-camera"></i> </a><a href="javascript:void()" class="btn btn-primary">등록</a>
                                              </div>
                                          </div>
                                      </div>
